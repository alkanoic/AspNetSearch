...
namespace AspNetSearch.Models.Search
{
    public class FetchTableInfoRepositoryInMemory : IFetchTableInfoRepository
    {
        ...
        private static Dictionary<int, DataModels.SearchTableColumnInfo> RepositoryColumnValue { get; set; }
        ...
        public FetchTableInfoRepositoryInMemory()
        {
            ...
            RepositoryColumnValue = new Dictionary<int, DataModels.SearchTableColumnInfo>();
            var column1 = new DataModels.SearchTableColumnInfo();
            column1.TableId = 1;
            column1.ColumnId = 1;
            column1.TableColumnName = "Column1";
            column1.TableColumnDisplayName = "列名1";
            RepositoryColumnValue.Add(column1.ColumnId, column1);
            ...
            RepositoryColumnValue.Add(column2.ColumnId, column2);
            ...
            RepositoryColumnValue.Add(column3.ColumnId, column3);
            ...
            RepositoryColumnValue.Add(column4.ColumnId, column4);
            ...
            RepositoryColumnValue.Add(column5.ColumnId, column5);
        }
        ...
        public FetchTableAllColumnInfoOutput FetchTableAllColumnInfo(FetchTableAllColumnInfoInput input)
        {
            ...
            foreach(var item in RepositoryColumnValue.Values.Where(i => i.TableId == input.TableId))
            {
        ...
        public FetchTableColumnInfoOutput FetchTableColumnInfo(FetchTableColumnInfoInput input)
        {
            ...
            if(RepositoryColumnValue.TryGetValue(input.ColumnId, out value))
            {
